...
muonL1MatcherParameters = cms.PSet(
    ...
    sortBy = cms.string("deltaPhi"),          # among compatible candidates, pick the highest pt one
...
muonL1Match = cms.EDProducer("L1MuonMatcher",
    ...
    # ResolveAmbiguities
    resolveAmbiguitiesByMatchQuality = cms.bool(False),
    sortByRes = cms.string("deltaPhi"), 
)
